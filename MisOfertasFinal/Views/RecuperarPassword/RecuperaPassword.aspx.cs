        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lsConsulta.Count > 0)
                {
                    ...
                    stCuerpoHTML += "Ingrese al siguiente link: " + "http:http://www.misofertas.somee.com/Views/ActualizadorContrasena/ActualizadorContrasena.aspx?asprt=" + rut+"&aspc="+correo;
                    stCuerpoHTML += "</p>";
