...
namespace MisOfertasFinal.Views.Index
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        {
            if (!String.IsNullOrEmpty(ddlRubro.SelectedValue) || ddlRubro.SelectedIndex == 0)
            {
        ...
        #region Obtener ofertas categoria
        ...
        #region Obtener ofertas por marca
        public void ObtenerOfertasPorMarca()
        {
            LogicaNegocio.LnOferta objLnOferta = new LnOferta();
            dtlOfertas.DataSource = objLnOferta.getOfertasProductosMarca(Convert.ToDecimal(ddlMarca.SelectedValue));
            dtlOfertas.DataBind();
        }
        #endregion
        ...
        {
            this.ObtenerOfertasPorCategoria();
        }

        protected void ddlMarca_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.ObtenerOfertasPorMarca();
        }
    }
}
