                                ...
                                <div>
                                        <div id="rating1">
                                            <div class="rating-avg">
                                               <p>Promedio de Valoraciónes: <asp:Label ID="Label1" runat="server"  Text='<%# Eval("calificacion") %> '></asp:Label></p>                                           
                                            </div>                                            
                                        </div>
                                    </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="tab1" class="tab-pane fade in active">
                                <div class="row">
                                    ...
                                    runat="server" ErrorMessage="Indique su numero de boleta" ControlToValidate="flSubir"
                                    CssClass="mensaje-validacion" ForeColor="Red">Indique una imagen de su boleta</asp:RequiredFieldValidator>
                                                <br></>
                                                <br></>
                                    ...
                                    runat="server" ErrorMessage="Indique su numero de boleta" ControlToValidate="txtNumeroBoleta"
                                    CssClass="mensaje-validacion" ForeColor="Red">Indique su numero de bolera</asp:RequiredFieldValidator>
                                                <br></>
                                                ...
                                                <br></>
                                                    <asp:DropDownList ID="ddlValoracion" runat="server" CssClass="form-control" Width="370px" AutoPostBack="false">
                                                        <asp:ListItem Text="Califica el producto" Value="" />
                                                    ...
                                                    <asp:RequiredFieldValidator CssClass="mensaje-validacion" ForeColor="Red" id="RFVvalores"
                                                        ControlToValidate="ddlValoracion" InitialValue="" runat="server">Debe ingresar una calificación</asp:RequiredFieldValidator>
                                                </div>
                                                <br></>
