            ...
            <div class="card text-center text-white card-login mx-auto mt-5">
                ...
                <div class="card-body text-dark">
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control" placeholder="Ingrese password" TextMode="Password"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator"
                                    runat="server" ErrorMessage="Indique su correo" ControlToValidate="txtPassword"
                                    CssClass="mensaje-validacion" ForeColor="Red">Indique su contraseña</asp:RequiredFieldValidator>
                        </div>
                        <br />
                        <div class="form-group">
                    ...
                    <div class="text-center">
                        ...
                        <a class="d-block small" href="../RecuperarPassword/RecuperaPassword.aspx">¿Olvidaste la contraseña?</a>
                    </div>
                    <br />
                </div>
            </div>
