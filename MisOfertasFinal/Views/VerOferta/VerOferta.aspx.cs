    ...
    public partial class VerOferta : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dtlOferta.DataBind();
                ObtenerProductosRelacionados(idCategoria);                

            }
        }
       
        public void ObtenerProductosRelacionados(decimal idCategoria)
        {
            LogicaNegocio.LnOferta objLnOferta = new LnOferta();
            dtlProRelacionados.DataSource = objLnOferta.getOfertasProductosCategoria(idCategoria);
        ...
        public void MensajeError() {
            ClientScript.RegisterStartupScript(this.GetType(), "mensaje", "<script>swal('Error!'," +
                          " 'Debe marcar alguna calificación', 'error')</script>");
        }
